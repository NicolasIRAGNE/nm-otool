...
static int	nm_found_option(char c, t_nm_browser *browser, int *options)
{
	if (c == 'p')
...
int			process_parse_options(char *str, t_nm_browser *browser,
...
int			parse_options(int *i, int ac, char **av, t_nm_browser *browser)
{
	int options;
	int ret;
